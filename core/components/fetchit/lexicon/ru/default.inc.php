...
$_lang['fetchit_err_pow'] = 'Не удалось подтвердить отправку. Отправьте форму ещё раз.';
$_lang['fetchit_err_captcha'] = 'Подтвердите, что вы не робот, и отправьте форму ещё раз.';
