...
$_lang['setting_fetchit.protection.pow_desc'] = 'Перед отправкой браузер решает небольшую задачу: при 16 компьютеру нужно около десятой доли секунды, а массовая рассылка становится дорогой. Нужен JavaScript: формы без него отклоняются. 0 выключает.';
$_lang['area_fetchit_captcha'] = 'Капча';
$_lang['setting_fetchit.captcha'] = 'Капча';
$_lang['setting_fetchit.captcha_desc'] = 'turnstile (Cloudflare Turnstile), recaptcha (Google reCAPTCHA v3) или smartcaptcha (Яндекс SmartCaptcha); пусто, если не нужна. Нужны оба ключа ниже и JavaScript.';
...
$_lang['setting_fetchit.captcha.min_score_desc'] = 'От 0 до 1; ответы с меньшим баллом отклоняются. Google советует 0.5.';
