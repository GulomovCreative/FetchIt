...
$_lang['setting_fetchit.protection.pow_desc'] = 'The browser solves a small puzzle before sending: 16 takes a computer about a tenth of a second and makes mass sending costly. Needs JavaScript: forms sent without it are refused. 0 turns it off.';
$_lang['area_fetchit_captcha'] = 'Captcha';
$_lang['setting_fetchit.captcha'] = 'Captcha';
$_lang['setting_fetchit.captcha_desc'] = 'turnstile (Cloudflare Turnstile), recaptcha (Google reCAPTCHA v3) or smartcaptcha (Yandex SmartCaptcha); empty for none. Needs both keys below and JavaScript.';
...
$_lang['setting_fetchit.captcha.min_score_desc'] = 'From 0 to 1; lower scores are refused. Google suggests 0.5.';
